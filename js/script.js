...
(function($) {
  ...
  THEMEMASCOT.isLTR = {
	...
	// 		// Convert event date to IST (Indian Standard Time)
	// 		var eventDateIST = new Date(finalDate + " UTC");
	// 		eventDateIST.setMinutes(eventDateIST.getMinutes() + 330); // Convert UTC to IST (+5:30)
	
	// 		$this.countdown(eventDateIST, function(event) {
	// 			var $this = $(this).html(event.strftime(
	// 				'<div class="counter-column"><span class="count">%m</span><sub>Month</sub></div> ' + 
    ...
    $('.time-countdown-two').each(function() {
        var $this = $(this);
        var finalDateIST = "2025-02-14T23:59:00Z"; // 14th Feb 2025, 11:59 PM UTC (Equivalent to 15th Feb 2025, 5:30 AM IST)

        $this.countdown(finalDateIST, function(event) {
            var $this = $(this).html(event.strftime(
                '<div class="counter-column"><span class="count">%m</span><sub>Month</sub></div> ' + 
                '<div class="counter-column"><span class="count">%D</span><sub>Days</sub></div> ' + 
                '<div class="counter-column"><span class="count">%H</span><sub>Hours</sub></div>  ' + 
